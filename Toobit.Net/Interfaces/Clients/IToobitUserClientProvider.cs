...
namespace Toobit.Net.Interfaces.Clients
{
    ...
    public interface IToobitUserClientProvider : IExchangeService
    {
        ...
        void InitializeUserClient(string userIdentifier, ApiCredentials credentials, ToobitEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        IToobitRestClient GetRestClient(string userIdentifier, ApiCredentials? credentials = null, ToobitEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        IToobitSocketClient GetSocketClient(string userIdentifier, ApiCredentials? credentials = null, ToobitEnvironment? environment = null);
    }
}