...
namespace Toobit.Net.Interfaces.Clients
{
    ...
    /// </summary>
    public interface IToobitUserClientProvider : IExchangeService
    {
        /// <summary>
        ...
        void InitializeUserClient(string userIdentifier, ToobitCredentials credentials, ToobitEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        IToobitRestClient GetRestClient(string userIdentifier, ToobitCredentials? credentials = null, ToobitEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        IToobitSocketClient GetSocketClient(string userIdentifier, ToobitCredentials? credentials = null, ToobitEnvironment? environment = null);
    }
}