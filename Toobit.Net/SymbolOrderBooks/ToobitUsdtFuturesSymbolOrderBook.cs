...
namespace Toobit.Net.SymbolOrderBooks
{
    ...
    /// </summary>
    public class ToobitUsdtFuturesSymbolOrderBook : SymbolOrderBook
    {
        ...
        public ToobitUsdtFuturesSymbolOrderBook(string symbol, Action<ToobitOrderBookOptions>? optionsDelegate = null)
        ...
        public ToobitUsdtFuturesSymbolOrderBook(
            string symbol,
            Action<ToobitOrderBookOptions>? optionsDelegate,
            ILoggerFactory? logger,
            IToobitRestClient? restClient,
            IToobitSocketClient? socketClient) : base(logger, "Toobit", "UsdtFutures", symbol)
        {
