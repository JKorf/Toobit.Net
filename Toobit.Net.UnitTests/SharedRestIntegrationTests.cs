...
namespace Toobit.Net.UnitTests
{
    ...
    internal class SharedRestIntegrationTests
    {
        ...
        private IToobitRestClientSpotApiShared GetSpotRestClient()
        {
            var collection = new ServiceCollection();
            collection.AddToobit(x => x.Rest.OutputOriginalData = true);
            ...
            return sp.GetRequiredService<IToobitRestClient>().SpotApi.SharedClient;
        }

        private IToobitRestClientUsdtFuturesApiShared GetFuturesRestClient()
        {
            var collection = new ServiceCollection();
            collection.AddToobit(x => x.Rest.OutputOriginalData = true);
            collection.AddLogging(x =>
            ...
            var sp = collection.BuildServiceProvider();
            return sp.GetRequiredService<IToobitRestClient>().UsdtFuturesApi.SharedClient;
        }
